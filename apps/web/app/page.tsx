...
export default function Home() {
  ...
  useEffect(() => {
    ...
    getProjects().then(p => setProjects(p.slice(0, 5)));
  ...
  return (
    <div style={{ padding: "40px 48px", maxWidth: 1100, margin: "0 auto" }} className="animate-fadeIn">
      ...
      {/* Quick Actions */}
      <h2 style={{ fontWeight: 600, color: "#94a3b8", marginBottom: 16, textTransform: "uppercase", letterSpacing: "0.05em", fontSize: 12 }}>Quick Start</h2>
